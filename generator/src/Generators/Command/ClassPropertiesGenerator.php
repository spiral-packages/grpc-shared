...
final readonly class ClassPropertiesGenerator
{
    ...
    public function generate(ClassDeclaration $class, array $properties): void
    {
        ...
        \uasort($properties, static fn(PropertyType $a, PropertyType $b) => $a->hasDefaultValue() <=> $b->hasDefaultValue());
        ...
        foreach ($properties as $property) {
            ...
            foreach ($property->attributes as $attribute) {
                ...
                if (\str_starts_with((string) $attribute['class'], 'Symfony\Component\Validator\Constraints')) {
